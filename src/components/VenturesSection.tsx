          ...
          {ventures.map((venture, i) => {
            ...
            return (
              <motion.a
                ...
                whileHover={{ y: -6 }}
                className="glass group flex flex-col p-6 transition-colors hover:border-indigo-400/50 hover:shadow-[0_0_32px_rgba(99,102,241,0.18)]"
              ...
              >
                ...
                <span className="mt-auto font-mono text-xs text-indigo-400 transition-colors group-hover:text-cyan-300">
                  {venture.displayUrl}
                </span>
              </motion.a>
            );
